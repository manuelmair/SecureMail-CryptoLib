...
public class SecureMailTest {
    ...
    public void emailEncryptionTest() throws Exception {
        ...
        SecureMail mail = new SecureMail(cipherConf, message, keyPairRecipient.getPublicKeyStr(), keyPairSender);
        ...
        switch (receivedMail.getSecureCipherConfig().asymCipher) {
            case RSA_4096:
                // load 4096 key
                decryptedMessage = receivedMail.decryptMessage(keyPairSender.getPublicKeyStr(), keyPairRecipient);
                break;
            case RSA_2048:
                // load 2048 key
                decryptedMessage = receivedMail.decryptMessage(keyPairSender.getPublicKeyStr(), keyPairRecipient);
